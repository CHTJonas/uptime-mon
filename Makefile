...
build/linux/mips64: dir mod
	...
	$(GOBUILD) -o bin/uptime-mon-linux-$(VER:v%=%)-mips64 main.go
...
build/linux/armv7: dir mod
	...
	export GOARCH=arm
	export GOARM=7
	$(GOBUILD) -o bin/uptime-mon-linux-$(VER:v%=%)-armv7 main.go

build/linux/arm64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=arm64
	$(GOBUILD) -o bin/uptime-mon-linux-$(VER:v%=%)-arm64 main.go

build/linux/386: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=386
	$(GOBUILD) -o bin/uptime-mon-linux-$(VER:v%=%)-386 main.go

build/linux/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=amd64
	$(GOBUILD) -o bin/uptime-mon-linux-$(VER:v%=%)-amd64 main.go
...
build/darwin/arm64: dir mod
	...
	export GOOS=darwin
	export GOARCH=arm64
	$(GOBUILD) -o bin/uptime-mon-darwin-$(VER:v%=%)-arm64 main.go

build/darwin/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=darwin
	export GOARCH=amd64
	$(GOBUILD) -o bin/uptime-mon-darwin-$(VER:v%=%)-amd64 main.go
...
build/windows/amd64: dir mod
	...
	export GOOS=windows
	export GOARCH=amd64
	$(GOBUILD) -o bin/uptime-mon-windows-$(VER:v%=%)-amd64 main.go
